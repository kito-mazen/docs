...
icon: 'list-radio'
---
In the decentralized financial realm of Mazen Finance, the Gauge system functions as the ecosystem's heartbeat, continuously pumping rewards to vitalize various liquidity pools.

### The Inner Workings of the Gauge System

Mazen users lock MZN to obtain veMZN, their passport to ecosystem governance.
$veMZN holders become ecosystem stewards, directing reward flows through voting
